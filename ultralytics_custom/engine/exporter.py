...
Requirements:
    $ pip install "ultralytics_custom[export]"
...
from ultralytics_custom import __version__
from ultralytics_custom.cfg import TASK2DATA, get_cfg
from ultralytics_custom.data import build_dataloader
from ultralytics_custom.data.dataset import YOLODataset
from ultralytics_custom.data.utils import check_cls_dataset, check_det_dataset
from ultralytics_custom.nn.autobackend import check_class_names, default_class_names
from ultralytics_custom.nn.modules import C2f, Classify, Detect, RTDETRDecoder
from ultralytics_custom.nn.tasks import ClassificationModel, DetectionModel, SegmentationModel, WorldModel
...
from ultralytics_custom.utils.checks import (
...
from ultralytics_custom.utils.downloads import attempt_download_asset, get_github_assets, safe_download
from ultralytics_custom.utils.export import export_engine, export_onnx
from ultralytics_custom.utils.files import file_size, spaces_in_path
from ultralytics_custom.utils.ops import Profile, nms_rotated
from ultralytics_custom.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if edgetpu:
            ...
            elif self.args.batch != 1:  # see github.com/ultralytics_custom/ultralytics_custom/pull/13420
        ...
        if imx:
            from ultralytics_custom.utils.torch_utils import FXModel
        ...
        for m in model.modules():
            ...
            if isinstance(m, Detect) and imx:
                from ultralytics_custom.utils.tal import make_anchors
