...
from ultralytics_custom.data import load_inference_source
from ultralytics_custom.data.augment import LetterBox, classify_transforms
from ultralytics_custom.nn.autobackend import AutoBackend
from ultralytics_custom.utils import DEFAULT_CFG, LOGGER, MACOS, WINDOWS, callbacks, colorstr, ops
from ultralytics_custom.utils.checks import check_imgsz, check_imshow
...
class BasePredictor:
    ...
    def __call__(self, source=None, model=None, stream=False, *args, **kwargs):
        ...
        Returns:
            (List[ultralytics_custom.engine.results.Results] | generator): Results objects or generator of Results objects.
        """
        self.stream = stream
        if stream:
    ...
    def stream_inference(self, source=None, model=None, *args, **kwargs):
        ...
        Yields:
            (ultralytics_custom.engine.results.Results): Results objects.
        """
