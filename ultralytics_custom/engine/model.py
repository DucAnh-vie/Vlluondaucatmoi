...
from ultralytics_custom.cfg import TASK2DATA, get_cfg, get_save_dir
from ultralytics_custom.engine.results import Results
from ultralytics_custom.hub import HUB_WEB_ROOT, HUBTrainingSession
from ultralytics_custom.nn.tasks import attempt_load_one_weight, guess_model_task, yaml_model_load
...
class Model(torch.nn.Module):
    ...
    def predict(
        ...
        **kwargs: Any,
        ...
        is_cli = (ARGV[0].endswith("yolo") or ARGV[0].endswith("ultralytics_custom")) and any(
    ...
    def track(
        ...
        **kwargs: Any,
        ...
        if not hasattr(self.predictor, "trackers"):
            from ultralytics_custom.trackers import register_tracker
    ...
    def benchmark(
        ...
        **kwargs: Any,
        ...
        It uses the 'benchmark' function from the ultralytics_custom.utils.benchmarks module. The benchmarking is
        ...
        """
        self._check_is_pytorch_model()
        from ultralytics_custom.utils.benchmarks import benchmark
    ...
    def tune(
        ...
        **kwargs: Any,
        ...
        When Ray Tune is enabled, it leverages the 'run_ray_tune' function from the ultralytics_custom.utils.tuner module.
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from ultralytics_custom.utils.tuner import run_ray_tune
    ...
    def names(self) -> Dict[int, str]:
        ...
        using the 'check_class_names' function from the ultralytics_custom.nn.autobackend module. If the predictor is not
