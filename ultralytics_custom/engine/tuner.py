...
from ultralytics_custom.utils import DEFAULT_CFG, LOGGER, callbacks, colorstr, remove_colorstr, yaml_print, yaml_save
from ultralytics_custom.utils.plotting import plot_tune_results
    ...
    def __call__(self, model=None, iterations=10, cleanup=True):
        ...
        for i in range(start, iterations):
            ...
            try:
                ...
                launch = [__import__("sys").executable, "-m", "ultralytics_custom.cfg.__init__"]  # workaround yolo not found
