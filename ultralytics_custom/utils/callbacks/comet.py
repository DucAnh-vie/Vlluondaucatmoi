...
from ultralytics_custom.utils import LOGGER, RANK, SETTINGS, TESTS_RUNNING, ops
from ultralytics_custom.utils.metrics import ClassifyMetrics, DetMetrics, OBBMetrics, PoseMetrics, SegmentMetrics
...
def _resume_or_create_experiment(args: SimpleNamespace) -> None:
    ...
    try:
        ...
        experiment.log_other("Created from", "ultralytics_custom")
...
def _log_plots(experiment, trainer) -> None:
    ...
    Examples:
        >>> from ultralytics_custom.utils.callbacks.comet import _log_plots
...
def on_fit_epoch_end(trainer) -> None:
    ...
    if curr_epoch == 1:
        from ultralytics_custom.utils.torch_utils import model_info_for_loggers
