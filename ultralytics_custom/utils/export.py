...
from ultralytics_custom.utils import IS_JETSON, LOGGER
...
def export_engine(
    ...
    Args:
        ...
        dataset (ultralytics_custom.data.build.InfiniteDataLoader, optional): Dataset for INT8 calibration. Defaults to None.
    ...
    if int8:
        ...
        class EngineCalibrator(trt.IInt8Calibrator):
            ...
            def __init__(
                self,
                dataset,  # ultralytics_custom.data.build.InfiniteDataLoader
                cache: str = "",
            ) -> None:
