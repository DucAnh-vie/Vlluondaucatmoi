...
from ultralytics_custom.utils.metrics import batch_probiou
...
class Profile(contextlib.ContextDecorator):
    ...
    Examples:
        >>> from ultralytics_custom.utils.ops import Profile
...
def masks2segments(masks, strategy="all"):
    ...
    """
    from ultralytics_custom.data.converter import merge_multi_segment
