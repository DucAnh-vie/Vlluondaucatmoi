...
from ultralytics_custom.utils import IS_COLAB, IS_KAGGLE, LOGGER, TryExcept, ops, plt_settings, threaded
from ultralytics_custom.utils.checks import check_font, check_version, is_ascii
from ultralytics_custom.utils.files import increment_path
...
class Colors:
    ...
    Examples:
        >>> from ultralytics_custom.utils.plotting import Colors
        >>> colors = Colors()
...
class Annotator:
    ...
    Examples:
        >>> from ultralytics_custom.utils.plotting import Annotator
...
def plot_labels(boxes, cls, names=(), save_dir=Path(""), on_plot=None):
    ...
    """
    import pandas  # scope for faster 'import ultralytics_custom'
    import seaborn  # scope for faster 'import ultralytics_custom'
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    Examples:
        >>> from ultralytics_custom.utils.plotting import save_one_box
        >>> xyxy = [50, 50, 150, 150]
...
def plot_results(file="path/to/results.csv", dir="", segment=False, pose=False, classify=False, on_plot=None):
    ...
    Examples:
        >>> from ultralytics_custom.utils.plotting import plot_results
