...
Usage:
    from ultralytics_custom.utils.benchmarks import ProfileModels, benchmark
...
from ultralytics_custom import YOLO, YOLOWorld
from ultralytics_custom.cfg import TASK2DATA, TASK2METRIC
from ultralytics_custom.engine.exporter import export_formats
from ultralytics_custom.utils import ARM64, ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from ultralytics_custom.utils.checks import IS_PYTHON_3_13, check_imgsz, check_requirements, check_yolo, is_rockchip
from ultralytics_custom.utils.downloads import safe_download
from ultralytics_custom.utils.files import file_size
from ultralytics_custom.utils.torch_utils import get_cpu_info, select_device
...
def benchmark(
    ...
    import pandas as pd  # scope for faster 'import ultralytics_custom'
...
class RF100Benchmark:
    ...
    def parse_dataset(self, ds_link_txt="datasets_links.txt"):
        ...
        os.chdir("rf-100")
        os.mkdir("ultralytics_custom-benchmarks")
