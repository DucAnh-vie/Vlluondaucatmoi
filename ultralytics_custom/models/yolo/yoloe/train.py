...
from ultralytics_custom.data import YOLOConcatDataset, build_grounding, build_yolo_dataset
...
from ultralytics_custom.utils.torch_utils import de_parallel
...
class YOLOETrainerFromScratch(YOLOETrainer):
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        Examples:
            >>> from ultralytics_custom.models.yoloe.train import YOLOETrainerFromScratch
