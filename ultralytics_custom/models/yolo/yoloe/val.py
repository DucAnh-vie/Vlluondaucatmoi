...
from ultralytics_custom.data import YOLOConcatDataset, build_dataloader, build_yolo_dataset
from ultralytics_custom.data.augment import LoadVisualPrompt
from ultralytics_custom.data.utils import check_det_dataset
from ultralytics_custom.models.yolo.detect import DetectionValidator
from ultralytics_custom.models.yolo.segment import SegmentationValidator
from ultralytics_custom.nn.modules.head import YOLOEDetect
from ultralytics_custom.nn.tasks import YOLOEModel
from ultralytics_custom.utils import LOGGER, TQDM
from ultralytics_custom.utils.torch_utils import select_device, smart_inference_mode
    ...
    def __call__(self, trainer=None, model=None, refer_data=None, load_vp=False):
        ...
        if trainer is not None:
            ...
            if isinstance(model, str):
                from ultralytics_custom.nn.tasks import attempt_load_weights
