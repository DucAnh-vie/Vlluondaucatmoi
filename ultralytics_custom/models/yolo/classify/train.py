...
from ultralytics_custom.data import ClassificationDataset, build_dataloader
from ultralytics_custom.engine.trainer import BaseTrainer
from ultralytics_custom.models import yolo
from ultralytics_custom.nn.tasks import ClassificationModel
from ultralytics_custom.utils import DEFAULT_CFG, LOGGER, RANK
from ultralytics_custom.utils.plotting import plot_images, plot_results
from ultralytics_custom.utils.torch_utils import is_parallel, strip_optimizer, torch_distributed_zero_first
...
class ClassificationTrainer(BaseTrainer):
    ...
    Examples:
        >>> from ultralytics_custom.models.yolo.classify import ClassificationTrainer
    ...
    def setup_model(self):
        ...
        """
        import torchvision  # scope for faster 'import ultralytics_custom'
