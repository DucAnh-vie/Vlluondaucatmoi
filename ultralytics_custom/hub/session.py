...
from ultralytics_custom.hub.utils import HELP_MSG, HUB_WEB_ROOT, PREFIX
from ultralytics_custom.utils import IS_COLAB, LOGGER, SETTINGS, TQDM, checks, emojis
from ultralytics_custom.utils.errors import HUBModelError
...
class HUBTrainingSession:
    ...
    def __init__(self, identifier):
        ...
        self.timers = {}  # holds timers in ultralytics_custom/utils/callbacks/hub.py
        self.model = None
        self.model_url = None
