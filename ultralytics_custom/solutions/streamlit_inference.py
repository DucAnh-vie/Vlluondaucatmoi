...
from ultralytics_custom.utils.downloads import GITHUB_ASSETS_STEMS
...
class Inference:
    ...
    def __init__(self, **kwargs: Any):
        ...
        """
        check_requirements("streamlit>=1.29.0")  # scope imports for faster ultralytics_custom package load speeds
    ...
    def source_upload(self):
        ...
        if self.source == "video":
            ...
            if vid_file is not None:
                ...
                with open("ultralytics_custom.mp4", "wb") as out:  # Open temporary file as bytes
                    out.write(g.read())  # Read bytes into file
                self.vid_file_name = "ultralytics_custom.mp4"
