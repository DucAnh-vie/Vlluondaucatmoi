...
from ultralytics_custom.solutions.solutions import BaseSolution, SolutionAnnotator, SolutionResults
...
class SecurityAlarm(BaseSolution):
    ...
    def send_email(self, im0, records=5):
        ...
        # Attach the image
        image_attachment = MIMEImage(img_bytes, name="ultralytics_custom.jpg")
