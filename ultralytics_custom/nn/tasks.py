...
from ultralytics_custom.nn.autobackend import check_class_names
...
from ultralytics_custom.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, colorstr, emojis, yaml_load
from ultralytics_custom.utils.checks import check_requirements, check_suffix, check_yaml
from ultralytics_custom.utils.loss import (
    E2EDetectLoss,
...
from ultralytics_custom.utils.ops import make_divisible
from ultralytics_custom.utils.plotting import feature_visualization
from ultralytics_custom.utils.torch_utils import (
    fuse_conv_and_bn,
    fuse_deconv_and_bn,
    initialize_weights,
    intersect_dicts,
...
try:
    ...
    thop = None  # conda support without 'ultralytics_custom-thop' installed
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def init_criterion(self):
        ...
        from ultralytics_custom.models.utils.loss import RTDETRDetectionLoss
...
class YOLOEModel(DetectionModel):
    ...
    def get_text_pe(self, text, batch=80, cache_clip_model=False, without_reprta=False):
        ...
        """
        from ultralytics_custom.nn.text_model import build_text_model
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from ultralytics_custom.utils.loss import TVPDetectLoss
...
class YOLOESegModel(YOLOEModel, SegmentationModel):
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from ultralytics_custom.utils.loss import TVPSegmentLoss
...
def torch_safe_load(weight, safe_only=False):
    ...
    Examples:
        >>> from ultralytics_custom.nn.tasks import torch_safe_load
        >>> ckpt, file = torch_safe_load("path/to/best.pt", safe_only=True)
    """
    from ultralytics_custom.utils.downloads import attempt_download_asset
    ...
    try:
        with temporary_modules(
            modules={
                "ultralytics_custom.yolo.utils": "ultralytics_custom.utils",
                "ultralytics_custom.yolo.v8": "ultralytics_custom.models.yolo",
                "ultralytics_custom.yolo.data": "ultralytics_custom.data",
            },
            attributes={
                "ultralytics_custom.nn.modules.block.Silence": "torch.nn.Identity",  # YOLOv9e
                "ultralytics_custom.nn.tasks.YOLOv10DetectionModel": "ultralytics_custom.nn.tasks.DetectionModel",  # YOLOv10
                "ultralytics_custom.utils.loss.v10DetectLoss": "ultralytics_custom.utils.loss.E2EDetectLoss",  # YOLOv10
            },
        ):
            if safe_only:
        ...
        if e.name == "models":
            raise TypeError(
                emojis(
                    ...
                    f"\nRecommend fixes are to train a new model using the latest 'ultralytics_custom' package or to "
