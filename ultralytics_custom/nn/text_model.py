...
from ultralytics_custom.utils import checks
...
class CLIP(TextModel):
    ...
    Examples:
        >>> from ultralytics_custom.models.sam import CLIP
        >>> import torch
    ...
    def __init__(self, size, device):
        ...
        Examples:
            >>> import torch
            >>> from ultralytics_custom.models.sam.modules.clip import CLIP
...
class MobileCLIP(TextModel):
    ...
    def __init__(self, size, device):
        ...
        Examples:
            >>> from ultralytics_custom.nn.modules import MobileCLIP
            >>> import torch
        ...
        if not Path(file).is_file():
            from ultralytics_custom import download
