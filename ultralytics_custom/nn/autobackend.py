...
from ultralytics_custom.utils import ARM64, IS_JETSON, IS_RASPBERRYPI, LINUX, LOGGER, PYTHON_VERSION, ROOT, yaml_load
from ultralytics_custom.utils.checks import check_requirements, check_suffix, check_version, check_yaml, is_rockchip
from ultralytics_custom.utils.downloads import attempt_download_asset, is_url
...
class AutoBackend(nn.Module):
    ...
    def __init__(
        ...
        # TF GraphDef
            ...
            from ultralytics_custom.engine.exporter import gd_outputs
        ...
        # NVIDIA Triton Inference Server
            ...
            from ultralytics_custom.utils.triton import TritonRemoteModel
    ...
    def forward(self, im, augment=False, visualize=False, embed=None, **kwargs):
        ...
        # CoreML
            ...
            if "confidence" in y:
                ...
                # from ultralytics_custom.utils.ops import xywh2xyxy
