...
from ultralytics_custom.utils import IterableSimpleNamespace, yaml_load
from ultralytics_custom.utils.checks import check_yaml
...
def on_predict_start(predictor: object, persist: bool = False) -> None:
    ...
    if cfg.tracker_type == "botsort" and cfg.with_reid and cfg.model == "auto":
        from ultralytics_custom.nn.modules.head import Detect
