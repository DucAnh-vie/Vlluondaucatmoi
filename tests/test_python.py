...
from ultralytics_custom import RTDETR, YOLO
from ultralytics_custom.cfg import MODELS, TASK2DATA, TASKS
from ultralytics_custom.data.build import load_inference_source
from ultralytics_custom.utils import (
    ARM64,
    ASSETS,
    DEFAULT_CFG,
    DEFAULT_CFG_PATH,
...
from ultralytics_custom.utils.torch_utils import TORCH_1_9
...
@pytest.mark.skipif(not ONLINE, reason="environment is offline")
def test_data_utils():
    """Test utility functions in ultralytics_custom/data/utils.py, including dataset stats and auto-splitting."""
    from ultralytics_custom.data.split import autosplit
    from ultralytics_custom.data.utils import HUBDatasetStats
    from ultralytics_custom.utils.downloads import zip_directory

    # from ultralytics_custom.utils.files import WorkingDirectory
...
def test_data_converter():
    ...
    from ultralytics_custom.data.converter import coco80_to_coco91_class, convert_coco
...
def test_data_annotator():
    ...
    from ultralytics_custom.data.annotator import auto_annotate
...
def test_events():
    ...
    from ultralytics_custom.hub.utils import Events
...
def test_cfg_init():
    """Test configuration initialization utilities from the 'ultralytics_custom.cfg' module."""
    from ultralytics_custom.cfg import check_dict_alignment, copy_default_cfg, smart_value
...
def test_utils_init():
    ...
    from ultralytics_custom.utils import get_git_branch, get_git_origin_url, get_ubuntu_version, is_github_action_running
...
def test_utils_checks():
    ...
    checks.check_version("ultralytics_custom", "8.0.0")
    checks.print_args()


@pytest.mark.skipif(WINDOWS, reason="Windows profiling is extremely slow (cause unknown)")
def test_utils_benchmarks():
    """Benchmark model performance using 'ProfileModels' from 'ultralytics_custom.utils.benchmarks'."""
    from ultralytics_custom.utils.benchmarks import ProfileModels
...
def test_utils_torchutils():
    ...
    from ultralytics_custom.nn.modules.conv import Conv
    from ultralytics_custom.utils.torch_utils import get_flops_with_torch_profiler, profile, time_sync
...
def test_utils_ops():
    ...
    from ultralytics_custom.utils.ops import (
        ltwh2xywh,
        ltwh2xyxy,
        make_divisible,
        xywh2ltwh,
...
def test_utils_files():
    ...
    from ultralytics_custom.utils.files import file_age, file_date, get_latest_run, spaces_in_path
...
def test_utils_patches_torch_save():
    ...
    from ultralytics_custom.utils.patches import torch_save

    mock = MagicMock(side_effect=RuntimeError)

    with patch("ultralytics_custom.utils.patches._torch_save", new=mock):
...
def test_nn_modules_conv():
    ...
    from ultralytics_custom.nn.modules.conv import CBAM, Conv2, ConvTranspose, DWConvTranspose2d, Focus
...
def test_nn_modules_block():
    ...
    from ultralytics_custom.nn.modules.block import C1, C3TR, BottleneckCSP, C3Ghost, C3x
...
def test_hub():
    ...
    from ultralytics_custom.hub import export_fmts_hub, logout
    from ultralytics_custom.hub.utils import smart_request
...
def test_classify_transforms_train(image, auto_augment, erasing, force_color_jitter):
    ...
    from ultralytics_custom.data.augment import classify_augmentations
...
def test_yolo_world():
    ...
    from ultralytics_custom.models.yolo.world.train_world import WorldTrainerFromScratch
...
def test_yoloe():
    ...
    from ultralytics_custom import YOLOE
    from ultralytics_custom.models.yolo.yoloe import YOLOEVPSegPredictor
    ...
    # Train, fine-tune
    from ultralytics_custom.models.yolo.yoloe import YOLOEPESegTrainer
