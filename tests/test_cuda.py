...
from ultralytics_custom.cfg import TASK2DATA, TASK2MODEL, TASKS
from ultralytics_custom.utils import ASSETS, WEIGHTS_DIR
...
def test_predict_sam():
    ...
    from ultralytics_custom.models.sam import Predictor as SAMPredictor
